...
public class ModSmithingTemplateItem extends Item {
    ...
    public static net.minecraft.world.item.SmithingTemplateItem createArmorTrimTemplate(ResourceKey<TrimPattern> pPatternKey) {
        return createArmorTrimTemplate(pPatternKey.location());
    }

    public static net.minecraft.world.item.SmithingTemplateItem createArmorTrimTemplate(ResourceLocation pLocation) {
        return new net.minecraft.world.item.SmithingTemplateItem(ARMOR_TRIM_APPLIES_TO, ARMOR_TRIM_INGREDIENTS, Component.translatable(Util.makeDescriptionId("trim_pattern", pLocation)).withStyle(TITLE_FORMAT), ARMOR_TRIM_BASE_SLOT_DESCRIPTION, ARMOR_TRIM_ADDITIONS_SLOT_DESCRIPTION, createTrimmableArmorIconList(), createTrimmableMaterialIconList());
    }

    public static net.minecraft.world.item.SmithingTemplateItem createNetheriteUpgradeTemplate() {
        return new net.minecraft.world.item.SmithingTemplateItem(ENDERITIUM_UPGRADE_APPLIES_TO, ENDERITIUM_UPGRADE_INGREDIENTS, ENDERITIUM_UPGRADE, ENDERITIUM_UPGRADE_BASE_SLOT_DESCRIPTION, ENDERITIUM_UPGRADE_ADDITIONS_SLOT_DESCRIPTION, createNetheriteUpgradeIconList(), createNetheriteUpgradeMaterialList());
    }
