...
public class WitheredScytheAttackedEvent {
    ...
    private static void execute(@Nullable Event event, LevelAccessor world, Entity entity, Entity sourceentity) {
        ...
        if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == ModItems.WITHERED_SCYTHE.get()) {
            ...
            if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == ModItems.WITHERED_SCYTHE.get() && entity instanceof LivingEntity _livEnt2 && _livEnt2.getMobType() == MobType.UNDEAD) {
