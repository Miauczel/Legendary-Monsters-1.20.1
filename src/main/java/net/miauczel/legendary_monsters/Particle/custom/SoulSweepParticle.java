...
public class SoulSweepParticle extends TextureSheetParticle {
    ...
    public float yaw;
    public float pitch;
    public SoulSweepParticle(ClientLevel pLevel, double pX, double pY, double pZ, SpriteSet spriteSet, double xd, double yd, double zd, float scale, float yaw, float pitch) {
    ...
    public static class Provider implements ParticleProvider<SweepData> {
        ...
        public Particle createParticle(SweepData options, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            SoulSweepParticle shriekparticle = new SoulSweepParticle(worldIn, x, y, z, sprite, xSpeed, ySpeed, zSpeed, options.getScale(), options.getYaw(), options.getPitch());
    ...
    public static class SweepData implements ParticleOptions {
        ...
        public ParticleType<SweepData> getType() {
            return ModParticles.SOUL_SWEEP.get();
        }
