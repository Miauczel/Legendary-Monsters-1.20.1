...
public abstract class AbstractNotGlowingTrailParticle extends Particle {
    ...
    public AbstractNotGlowingTrailParticle(ClientLevel world, double x, double y, double z, double xd, double yd, double zd, float r, float g, float b) {
        super(world, x, y, z);
        this.xd = xd;
        this.yd = yd;
        this.zd = zd;
    ...
    public void render(VertexConsumer consumer, Camera camera, float partialTick) {
        if (trailPointer > -1) {
            ...
            VertexConsumer vertexconsumer = multibuffersource$buffersource.getBuffer(LMRenderTypes.entityTranslucent(getTrailTexture()));
