...
@OnlyIn(Dist.CLIENT)
public class Tornado extends TextureSheetParticle {
    Tornado(ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
    ...
    public static class DamageIndicatorProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType pType, ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            Tornado critparticle = new Tornado(pLevel, pX, pY, pZ, pXSpeed, pYSpeed + 1.0D, pZSpeed);
    ...
    public static class MagicProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType pType, ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            Tornado critparticle = new Tornado(pLevel, pX, pY, pZ, pXSpeed, pYSpeed, pZSpeed);
            critparticle.pickSprite(this.sprite);
            return critparticle;
        }
    }
