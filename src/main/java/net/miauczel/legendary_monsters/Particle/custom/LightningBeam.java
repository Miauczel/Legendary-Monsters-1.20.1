...
@OnlyIn(Dist.CLIENT)
public class LightningBeam extends TextureSheetParticle {
    LightningBeam(ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
    ...
    public static class DamageIndicatorProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType pType, ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            LightningBeam critparticle = new LightningBeam(pLevel, pX, pY, pZ, pXSpeed, pYSpeed + 1.0D, pZSpeed);
    ...
    public static class MagicProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType pType, ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            LightningBeam critparticle = new LightningBeam(pLevel, pX, pY, pZ, pXSpeed, pYSpeed, pZSpeed);
            critparticle.pickSprite(this.sprite);
            return critparticle;
        }
    }
