...
public class SoulSigil extends TextureSheetParticle {
    ...
    public SoulSigil(ClientLevel world, double x, double y, double z, double motionX, double motionY, double motionZ, float yaw, float pitch, int duration, float r, float g, float b, float opacity, float size, boolean facesCamera, EnumRingBehavior behavior, SpriteSet sprites) {
        super(world, x, y, z);
    ...
    public static final class RingFactory implements ParticleProvider<RingData> {
        ...
        public Particle createParticle(RingData typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            SoulSigil particle = new SoulSigil(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, typeIn.getYaw(), typeIn.getPitch(), typeIn.getDuration(), typeIn.getR(), typeIn.getG(), typeIn.getB(), typeIn.getA(), typeIn.getScale(), typeIn.getFacesCamera(), typeIn.getBehavior(),spriteSet);
            return particle;
        }
    }
