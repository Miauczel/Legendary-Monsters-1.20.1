...
public abstract class AbstractFlyingProjectile extends Projectile {
    public double xPower;
    public double yPower;
    public double zPower;

    protected AbstractFlyingProjectile(EntityType<? extends AbstractFlyingProjectile> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    public AbstractFlyingProjectile(EntityType<? extends AbstractFlyingProjectile> pEntityType, double pX, double pY, double pZ, double pOffsetX, double pOffsetY, double pOffsetZ, Level pLevel) {
    ...
    public AbstractFlyingProjectile(EntityType<? extends AbstractFlyingProjectile> pEntityType, LivingEntity pShooter, double pOffsetX, double pOffsetY, double pOffsetZ, Level pLevel) {
