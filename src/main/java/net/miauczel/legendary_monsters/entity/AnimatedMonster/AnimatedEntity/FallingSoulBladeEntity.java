...
public class FallingSoulBladeEntity extends IHurtingEntity {
    ...
    private static final EntityDataAccessor<Boolean> IS_RED = SynchedEntityData.defineId(FallingSoulBladeEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    private static final EntityDataAccessor<Boolean> ATTACK = SynchedEntityData.defineId(FallingSoulBladeEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    public FallingSoulBladeEntity(Level worldIn, double x, double y, double z, float p_i47276_8_, int p_i47276_9_, LivingEntity casterIn, float damage, boolean isRed) {
        this(ModEntities.FALLING_SOUL_BLADE.get(), worldIn);
    ...
    protected void defineSynchedData() {
        this.entityData.define(ATTACK, Boolean.FALSE);

        this.entityData.define(IS_RED, Boolean.FALSE);
    ...
    public ControlledAnim controlledAnim1 = new ControlledAnim(15);
