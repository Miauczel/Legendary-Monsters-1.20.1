...
public class LaserBulletEntity extends AbstractFlyingProjectile{
    ...
    public void tick() {
        ...
        float b = 0/255F  ;
        this.level().addParticle((new LaserBulletTrail.OrbData(r, g, b,0.1F,0.3f,this.getId())),  dx, dy, dz, 0, 0, 0);
