...
@OnlyIn(Dist.CLIENT)
public class ChorusEnergyBulletModel extends Model {
    public static final ResourceLocation TEXTURE = new ResourceLocation(LegendaryMonsters.MOD_ID, "textures/entity/the_warped_one/projectile/chorus_energy_bullet.png");
    private final ModelPart root;

    public ChorusEnergyBulletModel(ModelPart pRoot) {
