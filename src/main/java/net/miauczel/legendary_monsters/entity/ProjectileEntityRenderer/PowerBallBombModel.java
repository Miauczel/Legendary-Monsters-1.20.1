...
public class PowerBallBombModel
        extends EntityModel<AnnihilationBombEntity> {

    private final ModelPart bone;
    private final ModelPart power_ball;
    public PowerBallBombModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(AnnihilationBombEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
