...
public class BigShulkerBulletRenderer extends EntityRenderer<BigShulkerBulletEntity> {
    ...
    private final BigShulkerBulletModel<BigShulkerBulletEntity> model;

   public BigShulkerBulletRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
        this.model = new BigShulkerBulletModel<>(pContext.bakeLayer(ModModelLayers.BIG_SHULKER_BULLET_LAYER));
    }
    public void render(BigShulkerBulletEntity pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource
     ...
     */
    public ResourceLocation getTextureLocation(BigShulkerBulletEntity pEntity) {
