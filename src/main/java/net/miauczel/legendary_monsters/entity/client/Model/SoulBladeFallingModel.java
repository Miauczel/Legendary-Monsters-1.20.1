...
public class SoulBladeFallingModel<T extends FallingSoulBladeEntity> extends HierarchicalModel<T> {
    public final ModelPart bb_main;

    public SoulBladeFallingModel(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition bb_main = partdefinition.addOrReplaceChild(
                ...
                PartPose.offset(0.0F, 115.0F, 0.0F)
        );
