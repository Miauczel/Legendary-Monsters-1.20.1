...
public class TheWarpedOneArmorLayer extends RenderLayer<TheObliteratorEntity, TheObliteratorModel<TheObliteratorEntity>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(LegendaryMonsters.MOD_ID,"textures/entity/the_warped_one/layer/the_warped_one_armor_layer.png");
    ...
    this.getParentModel().renderToBuffer(matrixStackIn, VertexConsumer, 15728640, OverlayTexture.NO_OVERLAY, 1f, 1f, 1f, 1f);
}else {
