...
public class TheObliteratorPowerBallOuterLayer extends RenderLayer<TheObliteratorEntity, TheObliteratorModel<TheObliteratorEntity>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(LegendaryMonsters.MOD_ID,"textures/entity/the_warped_one/ball/outer_ball_layer.png");
...
if (entity.isShootingClusterBomb()) {
    float f = 0.7f;
    this.getParentModel().renderToBuffer(matrixStackIn, VertexConsumer, 15728640, OverlayTexture.NO_OVERLAY, f, f, f, 1f);
}else {
