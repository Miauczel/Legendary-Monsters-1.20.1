...
@OnlyIn(Dist.CLIENT)
public class CloudGolemLaserBallInnerLayer extends RenderLayer<Cloud_GolemEntity, Cloud_GolemModel<Cloud_GolemEntity>> {
    private static final ResourceLocation LOCATION = new ResourceLocation(LegendaryMonsters.MOD_ID,"textures/entity/cloud_golem/laser_ball/laser_ball_inner.png");

    public CloudGolemLaserBallInnerLayer(Cloud_GolemRenderer renderIn) {
    ...
    this.getParentModel().renderToBuffer(matrixStackIn, VertexConsumer, 15728640, OverlayTexture.NO_OVERLAY, 0.76f, 0.76f, 0.76f, 0.6f);
}else {
