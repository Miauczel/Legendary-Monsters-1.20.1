...
public class LivingArmorModel<T extends HauntedKnightEntity> extends HierarchicalModel<T> {
	...
	private void applyHeadRotation(HauntedKnightEntity pEntity, float pNetHeadYaw, float pHeadPitch, float pAgeInTicks) {
