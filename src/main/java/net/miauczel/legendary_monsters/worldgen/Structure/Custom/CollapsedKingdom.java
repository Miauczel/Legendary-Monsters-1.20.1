...
public class CollapsedKingdom extends Structure {
    public static final int MAX_TOTAL_STRUCTURE_RANGE = 2000;
    public static final int MAX_PIECES = 100;
    public static final Codec<CollapsedKingdom> CODEC = ExtraCodecs.validate(RecordCodecBuilder
            .mapCodec((p_227640_) -> p_227640_.group(settingsCodec(p_227640_),
                    ...
                    Codec.intRange(0, MAX_PIECES).fieldOf("size").forGetter((p_227652_) -> p_227652_.maxDepth),
                    ...
                    .apply(p_227640_, CollapsedKingdom::new)), CollapsedKingdom::verifyRange).codec();
    ...
    private static DataResult<CollapsedKingdom> verifyRange(CollapsedKingdom p_286886_) {
        byte var10000;
    ...
    public CollapsedKingdom(StructureSettings p_227627_, Holder<StructureTemplatePool> p_227628_, Optional<ResourceLocation> p_227629_, int p_227630_, HeightProvider p_227631_, boolean p_227632_, Optional<Heightmap.Types> p_227633_, int p_227634_) {
        super(p_227627_);
    ...
    public CollapsedKingdom(StructureSettings pSettings, Holder<StructureTemplatePool> pStartPool, int pMaxDepth, HeightProvider pStartHeight, boolean pUseExpansionHack, Heightmap.Types pProjectStartToHeightmap) {
    ...
    public CollapsedKingdom(StructureSettings pSettings, Holder<StructureTemplatePool> pStartPool, int pMaxDepth, HeightProvider pStartHeight, boolean pUseExpansionHack) {
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext pContext) {
        ...
        return CollapsedKingdomJigsawPlacement.addPieces(pContext, this.startPool, this.startJigsawName, this.maxDepth, $$3, this.useExpansionHack, this.projectStartToHeightmap, this.maxDistanceFromCenter);
    }

    public StructureType<?> type() {
        return ModStructures.COLLAPSED_KINGDOM.get();
    }
}