...
public class NoWaterInStructureProcessor extends StructureProcessor {
    public static final Codec<NoWaterInStructureProcessor> CODEC = Codec.unit(NoWaterInStructureProcessor::new);
    ...
    protected StructureProcessorType<?> getType() {
        return ModProcessors.NO_WATER_PROCESSOR.get();
    }
